/*
 * Hash Generator API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Hash Generator API.
 * API Documentation: https://docs.apiverve.com/ref/hashgenerator
 */
...
{
    class HashGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/hashgenerator";

        /// <summary>
        /// Make a GET request to the Hash Generator API
        /// </summary>
        static async Task<JsonDocument> CallHashGeneratorAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling Hash Generator API...\n");

            var result = await CallHashGeneratorAPI();
