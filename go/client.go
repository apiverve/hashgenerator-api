...
const (
	baseURL        = "https://api.apiverve.com/v1/hashgenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Hash Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Hash Generator API client.
...
// Execute makes a request to the Hash Generator API with typed parameters.
//
