// Package hashgenerator provides a Go client for the Hash Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/hashgenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Hash Generator API.
//
// Parameters:
//   - text (required): string - Text to hash
//   - algorithms: string - Comma-separated list of algorithms or 'all'
type Request struct {
	Text string `json:"text"` // Required
	Algorithms string `json:"algorithms,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"algorithms": {Type: "string", Required: false},
	}
...
// ResponseData contains the data returned by the Hash Generator API.
type ResponseData struct {
	InputText string `json:"input_text"`
	InputLength int `json:"input_length"`
	AlgorithmsUsed []string `json:"algorithms_used"`
	Hashes HashesData `json:"hashes"`
	HashDetails []HashDetailsItem `json:"hash_details"`
	AvailableAlgorithms []string `json:"available_algorithms"`
}

// HashesData represents the hashes object.
type HashesData struct {
	Sha256 string `json:"sha256"`
	Md5 string `json:"md5"`
}

// HashDetailsItem represents an item in the HashDetails array.
type HashDetailsItem struct {
